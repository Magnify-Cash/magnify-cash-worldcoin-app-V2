...
export const MAGNIFY_WORLD_ADDRESS = import.meta.env.VITE_MAGNIFY_WORLD_ADDRESS;
...
export const USDC_ADDRESS = "0x176211869cA2b568f2A7D4EE941E073a821EE1ff"; // USDC token address
export const MAGNIFY_ADDRESS = MAGNIFY_WORLD_ADDRESS; // Alias for consistency
